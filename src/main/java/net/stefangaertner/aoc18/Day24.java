...
public class Day24 {
	...
	public static void main(String[] args) {
		List<String> lines = FileUtils.read("aoc18/024-data");
	...
	private static void part1(List<String> lines) {
		...
		System.out.println("#1 " + remainingType(armies) + " win, remaining units: " + countRemainingUnits(armies));
	}
	...
	private static void attack(List<Army> armies, Map<Army, Army> targets) {
		// sort by initiative
		armies.sort(Comparator.comparing(Army::getInitiative).reversed());
	...
	private static Map<Army, Army> getTargets(List<Army> armies) {
		...
		armies.sort(Comparator.comparing(Army::getEffectiveDamage).thenComparing(Army::getInitiative).reversed());
