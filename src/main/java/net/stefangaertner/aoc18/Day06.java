...
public class Day06 {
	...
	public static void main(String[] args) {
		...
		List<String> lines = FileUtils.read("aoc18/006-data");
	...
	private static void part1(int[][] grid, List<Coordinate> coords) {
		...
		System.out.println("#2 region size: " + maxSize);
	}

	private static void part2(int[][] grid, List<Coordinate> coords) {
		...
		System.out.println("#2 Region size: " + sum);
	}
