...
public class Day09 {
	...
	public static void main(String[] args) {
		...
		// computeScore(9, 25);
		// computeScore(10, 1618);
		// computeScore(13, 7999);
		// computeScore(17, 1104);
		// computeScore(21, 6111);
		// computeScore(30, 5807);

		// part 1
		System.out.println("#1 Highscore: " + computeScore(412, 71646));

		// part 2
		System.out.println("#2 Highscore: " + computeScore(412, 7164600));
	}
