...
public class Day14 {
	...
	public static void main(String[] args) {
		...
		System.out.println("#1: " + part1(409551, false));
		System.out.println("#2: " + part2("409551", false));

	}

	private static int part2(String needle, boolean debug) {
	...
	private static String part1(int after, boolean debug) {
